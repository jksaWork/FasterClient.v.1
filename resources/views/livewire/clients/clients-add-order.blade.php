                            ...
                            <form wire:submit.prevent="store()">
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            <fieldset class="form-group floating-label-form-group">
                                                ...
                                                <input type="text" wire:model.defer="sender_name" class="form-control"
                                                    placeholder="">
                                                @error('sender_name') <span class="text-danger error">{{ $message
                                                    }}</span>@enderror
                                            </fieldset>
                                        </div>
                                        <div class="col-md-6 col-sm-12">
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <select wire:model.defer="sender_sub_area_id"
                                                    class="select2 senderSubAreaSelect2 form-control "
                                                    style="width:100%">
                                                    <option value="">----</option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            <fieldset class="form-group floating-label-form-group">
                                                ...
                                                <input type="text" wire:model.defer="receiver_phone_no"
                                                    class="form-control" placeholder="">
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <select wire:model.defer="receiver_area_id"
                                                    class="select2 receiverAreaSelect2 form-control "
                                                    style="width:100%">
                                                    <option value="">----</option>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <select wire:model.defer="receiver_sub_area_id"
                                                    class="select2 receiverSubAreaSelect2 form-control "
                                                    style="width:100%">
                                                    <option value="">----</option>
                                                ...
                                                @error('receiver_sub_area_id') <span class="text-danger error">{{
                                                    $message
                                                    }}</span>@enderror
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-sm-12">
                                            <fieldset class=form-group floating-label-form-group">
                                                ...
                                                <input type="text" wire:model.defer="receiver_address"
                                                    class="form-control" placeholder="">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class='col-md-3'>
                                                <fieldset class="form-group floating-label-form-group">
                                                    ...
                                                    <input type="text" wire:model.defer="number_of_pieces"
                                                        class="form-control" placeholder="">
                                ...
                                <div class="card-footer">
                                    <div class="px-2">
                                        ...
                                        <input type="submit" class="btn btn-info btn-sm btn-lg"
