        ...
        <div class="row px-3 py-2">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="order_date" wire:model='to_order_date' id=""
                        aria-describedby="helpId" placeholder="">
                    @error('order_date')
                    <small id="helpId" class="form-text text-danger">{{$message}}</small>
                    @enderror
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <div wire:ignore.self class="modal animated bounceInDown fade text-left"
                            id="showModal{{$order->id}}" role="dialog" aria-labelledby="myModalLabel35"
                            aria-hidden="true">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-8">
                                                        ...
                                                        <a href="{{asset('uploads/'.$order->police_file)}}">
                                                            <i class="la la-link"></i>{{__('translation.police.file')}}
                                                        </a>
                                                        @else
                                                        -
                                                        @endif
