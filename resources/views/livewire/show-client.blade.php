                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <fieldset class="form-group floating-label-form-group">
                                            ...
                                            <input type="text" wire:model.defer="civil_registry" class="form-control" id="email"
                                                placeholder="">
                                    ...
                                    <div class="col-md-6">
                                        <fieldset class="form-group floating-label-form-group">
                                            ...
                                            <input type="number" wire:model.defer="bank_account_number" class="form-control" id="email"
                                                placeholder="">
