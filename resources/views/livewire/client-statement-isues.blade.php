                        ...
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body card-dashboard">
                                    ...
                                    <div class="table-responsive">                                    <table class="table datatable table-striped table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>{{__('translation.total_fo_servie')}}</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $item->total_order_fess}}</td>
                                                <td>{{ $item->total_deleviry_fess }}</td>
                                                <td>{{ $item->total_shiping_type }}</td>
                                                <td>{{ $item->total_service_fess}}</td>
