                    ...
                    <li class="nav-item dropdown header-profile">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a href="{{ route('profile') }}" class="dropdown-item ai-icon">
                                ...
                                <span class="ml-2">{{ __('translation.profile') }} </span>
                            </a>
                            <a href="{{ route('accountTransaction') }}" class="dropdown-item ai-icon">
                                <svg id="icon-user1" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                <span class="ml-2">{{ __('translation.account_details') }} </span>
                            </a>
                            <a href="#" onclick="document.getElementById('logout').submit()" class="dropdown-item ai-icon">
                                ...
                                <span class="ml-2"  >{{ __('translation.logout') }} </span>
                            </a>
