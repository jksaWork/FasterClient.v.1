...
class ShowGeneralSettings extends Component
{
    ...
    public function mount()
    {
        ...
        $this->representative_percentage = Setting::where('key', 'representative_percentage')->first()->value;
        $this->order_return_price = Setting::where('key', 'order_return_price')->first()->value;
        $this->exceeding_order_ranges_bounce = Setting::where('key', 'exceeding_order_ranges_bounce')->first()->value;
    }
