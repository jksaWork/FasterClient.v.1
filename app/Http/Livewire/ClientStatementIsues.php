...
class ClientStatementIsues extends Component
{
    ...
    public function getData()
    {
        ...
        return $data = IssueClientStatement::latest()->paginate(10);
    }
    ...
    public function getDataWithName()
    {
        ...
        return $data = IssueClientStatement::where('client_id', $this->client_id)
    ...
    public function render()
    {
        ...
        if($this->status && $this->status != 'all'){
            if(!!$data->count()) $data = $data->toQuery()->where('status' , $this->status)->paginate(10);
        }
