...
class ShowRepresentativesFeesCollection extends Component
{
    ...
    public function render()
    {
        ...
        foreach ($representatives as $key => $value) {
            $value->orders_count = Order::where(['representative_id' => $value->id, 'status' => 'delivered'])->count();
        }
        return view('livewire.show-representatives-fees-collection', [
            'data' => Order::whereRepresentativeIdAndStatus($this->representative_id, 'delivered')->isDeleted()->paginate(10),
